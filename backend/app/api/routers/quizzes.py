...
from app.schemas.quiz import QuizResponse, QuizSubmitRequest, QuizAttemptResponse, QuizQuestionResponse
...
async def get_quiz_questions(quiz_id: str, db: AsyncSession = Depends(get_db)):
    """Get questions for a specific quiz from database."""
